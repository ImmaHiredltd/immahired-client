  ...
  return (
        ...
        <ToastContainer />
            ...
            >
              ...
              <ParallaxLayer offset={isMobile ? 3.9 : 3.5} speed={0.3} className="flex sm:flex-row flex-col justify-center gap-20 max-sm:px-5">
              ...
              <ParallaxLayer offset={ isMobile ? 4.5 : 4.1} className="max-sm:hidden">
