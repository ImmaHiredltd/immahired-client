  ...
  return (
    <div className="flex xl:flex-row flex-col items-center h-full max-[380px]:gap-10 gap-16">
        ...
        <div className="relative w-full max-w-[670px] max-[380px]:rounded-xl rounded-3xl overflow-hidden shadow-2xl">
          ...
          >
            <div className="relative flex items-center justify-center">
              ...
              {/* PLAY / PAUSE ICON */}
              <div className={`w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition-opacity duration-300 ${!isPlaying
      ...
      >
        ...
        <h2 className={`text-3xl max-[380px]:text-xl ${isMobileHeight && isMobileHeight && "text-lg"} sm:text-xl font-semibold mb-6`}>
          {target.about_us_1}
        </h2>
